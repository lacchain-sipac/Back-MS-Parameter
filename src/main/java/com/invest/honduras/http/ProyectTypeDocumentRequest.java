...
@Getter
@Setter
public class ProyectTypeDocumentRequest {
	...
	@NotNull
	@JsonProperty("code_document_type")
	@ApiModelProperty(notes = "codigo del tipo de acceso" , example ="doc_02_01_01")
	private String documentType	;
	
	@NotNull
	@JsonProperty("code_type_action")
